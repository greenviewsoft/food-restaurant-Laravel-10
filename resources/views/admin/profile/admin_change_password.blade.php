...
<div class="page-content">
        ...
        <div class="d-flex flex-column align-items-center text-center">
            <img src="{{ !empty($profileData->avatar) ? url('uploads/admin_images/' . $profileData->avatar) : $profileData->avatar }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
            <div class="mt-3">

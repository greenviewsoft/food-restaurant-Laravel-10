<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('admin.slider.index') }}"><i class='bx bx-radio-circle'></i>All Slider</a>
                <li> <a href="{{ route('admin.slider.create') }}"><i class='bx bx-radio-circle'></i>Create Slider</a>
                </li>
